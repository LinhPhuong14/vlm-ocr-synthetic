...
| [`layouts84/`](layouts84) | 84 | **mọi bố cục, hai lần, không hai ảnh liền kề cùng bố cục** — the first set built after the plan started dealing layouts round-robin instead of drawing them in blocks. 42 layouts × 2, 6 346 boxes, and one honest defect it was committed with rather than regenerated around — see its own [README](layouts84/README.md) |
