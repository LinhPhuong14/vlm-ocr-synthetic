...
def test_every_committed_page_has_a_record_in_the_shape_this_file_defines():
    ...
    #
    # 3278 = the 278 that were already here plus the first three 1000-page
    # batches of `data/5k_llm`; it reaches 5278 when the last one lands. The
