...
from augment import DEFAULT_CHAIN, apply_chain  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("-o", "--out", type=Path, default=Path("data/augment"))
    ...
    for source in ("synthdog", "genalog"):
        directory = getattr(args, source)
