# Adapted from tanguymagne/SyntheticDoc (generation/rendering/config.py), MIT License.
# See ../LICENSE. Trimmed to what sample_renderer.py here still uses -- the ground-truth
# passes this repo does not render (shadow, albedo, 3D, normal) are dropped, and their
# constants with them.
