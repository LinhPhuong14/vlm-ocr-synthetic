...
characters. That is not nostalgia: `src/pipeline/preflight.py` checks every glyph
this rule-base can print against every font in `assets/fonts/`, and two of those fonts
