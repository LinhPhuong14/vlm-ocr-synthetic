...
# Same convention as `src/pipeline/preflight.py`: a check that could not run is not
...
# so `src/pipeline/drift.py` can read it without importing the module that writes it.
